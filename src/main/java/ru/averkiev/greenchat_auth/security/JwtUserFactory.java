...
/**
 * Класс предоставляет статические сетоды для создания объекта JwtUser из объекта User и преобразования ролей
...
public class JwtUserFactory {
    ...
    /**
     * Создаёт и возвращает щбъект JwtUser на основе переданного объекта User. Преобразует поля объекта User
